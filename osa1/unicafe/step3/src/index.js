...
const Statistics = props => <div>Good {props.good}<br />Neutral {props.neutral}<br />Bad {props.bad}<br />All {props.all}<br />Average {props.avg}<br />Positive {props.positive} %</div>
